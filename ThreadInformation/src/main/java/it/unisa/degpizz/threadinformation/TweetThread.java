...
public class TweetThread extends Thread {
    ...
    private InformationCounter informationCounter;
    private Gson gson;
    private String name;

    public TweetThread(String name, InformationCounter informationCounter, AtomicInteger counterTextParsed, AtomicInteger counterFileParsed, AtomicInteger parseTextError, AtomicInteger fileOpenError, File[] filesToParse) {
        this.name = name;
        ...
        this.informationCounter = informationCounter;
        ...
        for (File f : filesToParse) {
            ...
            try (BufferedReader br = getBufferedReaderForCompressedFile(f)) {
                ...
                while (jsonStreamParser.hasNext()) {
                    ...
                    informationCounter.parseTweet(tweets);
                }
